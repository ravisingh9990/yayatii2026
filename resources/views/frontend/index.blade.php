                                ...
                                <div class="mil-mb-90">
                                    ...
                                    <div class="mil-about-quote">
                                        <div class="mil-avatar mil-up">
                                            <img src="{{url('frontend/img/faces/customers/2.png')}}" alt="Founder">
                                        </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="mil-about-photo mil-mb-90">
                                    ...
                                    <div class="mil-up mil-img-frame" style="padding-bottom: 160%;">
                                        <img src="{{url('frontend/img/photo/1.jpg')}}" alt="img" class="mil-scale" data-value-1="1" data-value-2="1.2">
                                    </div>
                                </div>
                        ...
                        <div class="container mil-p-120-0">
                            ...
                            <div class="mil-mb-120">
                                ...
                                <div class="mil-complex-text justify-content-center mil-up mil-mb-15">
                                    ...
                                    <span class="mil-text-image"><img src="{{url('frontend/img/photo/2.jpg')}}" alt="team"></span>
                            ...
                            <div class="row mil-services-grid m-0">
                                <div class="col-md-6 col-lg-3 mil-services-grid-item p-0">
                                    ...
                                    <a href="service.html" class="mil-service-card-sm mil-up">
                                        ...
                                        <p class="mil-light-soft mil-mb-30">We help your brand grow through a strong, unique identity that resonates with your customers.</p>
                                ...
                                <div class="col-md-6 col-lg-3 mil-services-grid-item p-0">
                                    ...
                                    <a href="service.html" class="mil-service-card-sm mil-up">
                                        ...
                                        <p class="mil-light-soft mil-mb-30">Our team crafts visually appealing and user-friendly websites that drive engagement and achieve your business goals.</p>
                                        <div class="mil-button mil-icon-button-sm mil-arrow-place"></div>
                                    </a>
                                ...
                                <div class="col-md-6 col-lg-3 mil-services-grid-item p-0">
                                    ...
                                    <a href="service.html" class="mil-service-card-sm mil-up">
                                        ...
                                        <p class="mil-light-soft mil-mb-30">We create impactful advertising campaigns that capture attention and boost your brand's visibility.</p>
                                        <div class="mil-button mil-icon-button-sm mil-arrow-place"></div>
                                    </a>
                                ...
                                <div class="col-md-6 col-lg-3 mil-services-grid-item p-0">
                                    ...
                                    <a href="service.html" class="mil-service-card-sm mil-up">
                                        ...
                                        <p class="mil-light-soft mil-mb-30">Unlock your brand's potential with our creative consulting services, where we innovate and develop tailored solutions for your business.</p>
                                        <div class="mil-button mil-icon-button-sm mil-arrow-place"></div>
                                    </a>
                                    ...
                                    <div class="row mil-mb-60">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mil-team-card mil-up mil-mb-30">
                                                <img src="{{url('frontend/img/faces/1.jpg')}}" alt="Team member">
                                                <div class="mil-description">
                                                    <div class="mil-secrc-text">
                                                        <h5 class="mil-muted mil-mb-5"><a href="home-2.html">Ravi Chauhan</a></h5>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mil-team-card mil-up mil-mb-30">
                                                <img src="{{url('frontend/img/faces/2.jpg')}}" alt="Team member">
                                                <div class="mil-description">
                                                    <div class="mil-secrc-text">
                                                        <h5 class="mil-muted mil-mb-5"><a href="home-2.html">Kapil Chauhan</a></h5>
                                                        <p class="mil-link mil-light-soft mil-mb-10">Founder</p>
                                                        <ul class="mil-social-icons mil-center">
                                                            <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-behance"></i></a></li>
                                                            <li><a href="#." target="_blank" class="social-icon"> <i class="fab fa-dribbble"></i></a></li>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Lakshay Verma</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Ayurweave</p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Deepak Chauhan</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Vahan Drive</p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Manoj Kumar</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Bansal Capital</p>
                                                <p class="mil-text-xl mil-up">This creative agency stands out with their exceptional talent and expertise. Their ability to think outside the box and bring unique ideas to life is truly impressive. With meticulous attention to detail, they consistently deliver visually stunning and impactful work.</p>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Mohit Singh</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Binary Enterprises</p>
                                                <p class="mil-text-xl mil-up">I had the pleasure of working with this creative agency, and I must say, they truly impressed me. They consistently think outside the box, resulting in impressive and impactful work. I highly recommend this agency for their consistent delivery of exceptional creative solutions.</p>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Vipin Kumar</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Vipin Buildtech</p>
                                                <p class="mil-text-xl mil-up">This creative agency stands out with their exceptional talent and expertise. Their ability to think outside the box and bring unique ideas to life is truly impressive. With meticulous attention to detail, they consistently deliver visually stunning and impactful work.</p>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Gagan Kumar</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Lavitate Entertainment</p>
                                                <p class="mil-text-xl mil-up">I had the pleasure of working with this creative agency, and I must say, they truly impressed me. They consistently think outside the box, resulting in impressive and impactful work. I highly recommend this agency for their consistent delivery of exceptional creative solutions.</p>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="mil-review-frame mil-center" data-swiper-parallax="-200" data-swiper-parallax-opacity="0">
                                                <h5 class="mil-up mil-mb-10">Neeraj Verma</h5>
                                                <p class="mil-mb-5 mil-upper mil-up mil-mb-30">Verma Enterprises</p>
                                                <p class="mil-text-xl mil-up">This creative agency stands out with their exceptional talent and expertise. Their ability to think outside the box and bring unique ideas to life is truly impressive. With meticulous attention to detail, they consistently deliver visually stunning and impactful work.</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="mil-soft-bg">
                    <div class="container mil-p-0-120">
                        ...
                        <div class="swiper-container mil-infinite-show mil-up">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame" style="width: 60px;"><img src="{{url('frontend/img/partners/1.svg')}}" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame" style="width: 100px;"><img src="{{url('frontend/img/partners/2.svg')}}" alt="logo"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#." class="mil-partner-frame" style="width: 60px;"><img src="{{url('frontend/img/partners/1.svg')}}" alt="logo"></a>
                                </div>
                    ...
                    <div class="container mil-p-120-60">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a href="publication.html" class="mil-blog-card mil-mb-60">
                                    <div class="mil-cover-frame mil-up">
                                        <img src="{{url('frontend/img/blog/1.jpg')}}" alt="cover">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="publication.html" class="mil-blog-card mil-mb-60">
                                    <div class="mil-cover-frame mil-up">
                                        <img src="{{url('frontend/img/blog/2.jpg')}}" alt="cover">
                                    </div>
                                    <div class="mil-post-descr">
                                        <div class="mil-labels mil-up mil-mb-30">
                                            <div class="mil-label mil-upper mil-accent">TECHNOLOGY</div>
