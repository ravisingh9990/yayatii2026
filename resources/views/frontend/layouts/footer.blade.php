                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-30">yayatii.com</div>
                            ...
                            <div class="row justify-content-between flex-sm-row-reverse">
                                <div class="col-md-7 col-lg-6">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <h6 class="mil-muted mil-up mil-mb-30">Delhi</h6>

                                            <p class="mil-light-soft mil-up">Office No. 204, 2nd Floor, Mangalam Palace, Rohini Sec-3, Delhi - 110085, <br> <span class="mil-no-wrap">9958 077 294</span></p>
                                ...
                                <div class="col-md-4 col-lg-6 mil-mb-60">
                                    ...
                                    <div class="mil-vert-between">
                                        ...
                                        <p class="mil-light-soft mil-up">© Copyright 2025 - Yayatii Digital. All Rights Reserved.</p>
                                    </div>
    ...
    <!-- swup js -->
    <script src="{{url('frontend/js/plugins/swup.min.js')}}"></script>
    <!-- swiper js -->
    <script src="{{url('frontend/js/plugins/swiper.min.js')}}"></script>
    <!-- fancybox js -->
    <script src="{{url('frontend/js/plugins/fancybox.min.js')}}"></script>
    <!-- gsap js -->
    <script src="{{url('frontend/js/plugins/gsap.min.js')}}"></script>
    <!-- scroll smoother -->
    <script src="{{url('frontend/js/plugins/smooth-scroll.js')}}"></script>
    <!-- scroll trigger js -->
    <script src="{{url('frontend/js/plugins/ScrollTrigger.min.js')}}"></script>
    <!-- scroll to js -->
    <script src="{{url('frontend/js/plugins/ScrollTo.min.js')}}"></script>
    <!-- Yayatii Digital js -->
