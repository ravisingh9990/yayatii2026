...
<head>
    ...
    <!-- bootstrap grid css -->
    <link rel="stylesheet" href="{{url('frontend/css/plugins/bootstrap-grid.css')}}">
    <!-- font awesome css -->
    <link rel="stylesheet" href="{{url('frontend/css/plugins/font-awesome.min.css')}}">
    <!-- swiper css -->
    <link rel="stylesheet" href="{{url('frontend/css/plugins/swiper.min.css')}}">
    <!-- fancybox css -->
    <link rel="stylesheet" href="{{url('frontend/css/plugins/fancybox.min.css')}}">
    <!-- Yayatii Digital scss -->
    <link rel="stylesheet" href="{{url('frontend/css/style.css')}}">
    <!-- page name -->
    <title>Yayatii Digital</title>
    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-menu-frame">
            ...
            <div class="mil-frame-top">
                <a href="{{ url('/') }}" class="mil-logo">Yayatii Digital</a>
        ...
        <div class="mil-frame">
            <div class="mil-frame-top">
                <a href="home-1.html" class="mil-logo">Yayatii Digital</a>
                <div class="mil-menu-btn">
                    <span></span>
                </div>
            </div>
